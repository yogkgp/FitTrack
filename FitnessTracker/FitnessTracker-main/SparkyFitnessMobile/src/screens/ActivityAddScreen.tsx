...
const ActivityAddScreen: React.FC<Props> = ({ navigation, route }) => {
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      Toast.show({
        type: 'error',
        text1: t('activityAdd.errors.saveFailed', {
        ...
        <Pressable onPress={dismissEditing}>
            ...
            {isNameEditing ? (
              <FadeView key="name-edit">
                <FormInput
                  ...
                  placeholder={t('activityAdd.fields.activity', {
                    defaultValue: 'Activity',
                  })}
                  accessibilityLabel={t(
                    'activityAdd.accessibility.activityName',
              ...
              <FadeView key="name-view">
                <TouchableOpacity
                  ...
                  accessibilityLabel={t(
                    'activityAdd.accessibility.editActivityName',
                    { defaultValue: 'Edit activity name' }
                  )}
                >
                  <Text className="text-xl font-bold text-text-primary">
                    {state.name ||
                      state.exerciseName ||
                      t('activityAdd.fields.activity', {
                        defaultValue: 'Activity',
                      })}
                  </Text>
          ...
          <View className="flex-row items-center mb-4">
            ...
            {state.entryDate === getTodayDate() ? (
              <TouchableOpacity
                ...
                accessibilityRole="button"
                accessibilityLabel={t(
                  'activityAdd.accessibility.useYesterday',
              ...
              >
                <Text className="text-text-link text-sm font-medium mx-1.5">
                  {t('activityAdd.actions.useYesterday', {
                    defaultValue: 'Use Yesterday',
                  })}
                </Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                activeOpacity={0.7}
                accessibilityRole="button"
                accessibilityLabel={t('activityAdd.accessibility.useToday', {
              ...
              >
                <Text className="text-text-link text-sm font-medium mx-1.5">
                  {t('activityAdd.actions.useToday', {
                    defaultValue: 'Use Today',
                  })}
                </Text>
              </TouchableOpacity>
            ...
            {state.exerciseId ? (
              ...
              <FadeView key="exercise-empty">
                <View className="flex-row items-center">
                  ...
                  >
                    {t('activityAdd.actions.selectActivity', {
          ...
          <View className="mb-4">
            ...
            <FormInput
              ...
              accessibilityLabel={t('activityAdd.accessibility.duration', {
          ...
          <View className="mb-4">
            ...
            <FormInput
              ...
              accessibilityLabel={t('activityAdd.accessibility.distance', {
                defaultValue: 'Distance in {{unit}}',
          ...
          <View className="mb-4">
            <Text className="text-sm font-medium text-text-secondary mb-1.5">
              {t('activityAdd.fields.calories', { defaultValue: 'Calories' })}
            </Text>
            <FormInput
              value={state.calories}
              onChangeText={setCalories}
              accessibilityLabel={t('activityAdd.accessibility.calories', {
            ...
            <Text className="text-xs text-text-muted mt-1">
              {state.caloriesManuallySet
                ? t('activityAdd.labels.custom', { defaultValue: 'Custom' })
                : t('activityAdd.labels.autoCalculated', {
          ...
          <View className="mb-4">
            <Text className="text-sm font-medium text-text-secondary mb-1.5">
              {t('activityAdd.fields.avgHeartRate', {
                defaultValue: 'Avg Heart Rate (bpm)',
              })}
            </Text>
            <FormInput
              value={state.avgHeartRate}
              onChangeText={setAvgHeartRate}
              accessibilityLabel={t('activityAdd.accessibility.avgHeartRate', {
                defaultValue: 'Average heart rate in beats per minute',
              })}
              placeholder="0"
          ...
          <View className="mb-6">
            <Text className="text-sm font-medium text-text-secondary mb-1.5">
              {t('activityAdd.fields.notes', { defaultValue: 'Notes' })}
            </Text>
            <FormInput
              value={state.notes}
              onChangeText={setNotes}
              accessibilityLabel={t('activityAdd.accessibility.notes', {
                defaultValue: 'Activity notes',
              })}
              placeholder={t('activityAdd.fields.notesPlaceholder', {
