...
export const ensureHistoryReadPermission =
  HealthConnect.ensureHistoryReadPermission;
...
export const getAggregatedTotalCaloriesByDate =
  HealthConnect.getAggregatedTotalCaloriesByDate;
export const getAggregatedTotalCaloriesByDateDetailed =
  HealthConnect.getAggregatedTotalCaloriesByDateDetailed;
export const getAggregatedDistanceByDate =
  HealthConnect.getAggregatedDistanceByDate;
export const getAggregatedDistanceByDateDetailed =
  HealthConnect.getAggregatedDistanceByDateDetailed;
export const getAggregatedFloorsClimbedByDate =
  HealthConnect.getAggregatedFloorsClimbedByDate;
export const getAggregatedFloorsClimbedByDateDetailed =
  HealthConnect.getAggregatedFloorsClimbedByDateDetailed;
...
export const getClientUnavailableCount =
  HealthConnect.getClientUnavailableCount;
