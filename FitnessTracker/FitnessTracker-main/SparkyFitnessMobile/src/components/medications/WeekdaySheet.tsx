...
const WeekdaySheet = forwardRef<WeekdaySheetRef, WeekdaySheetProps>(
  ({ value, onChange }, ref) => {
            ...
            return (
              <TouchableOpacity
                ...
                accessibilityLabel={t('medications.weekdays.itemA11y', {
                  ...
                  day: label,
                  state: selected
                    ? t('medications.weekdays.selected', {
                        defaultValue: 'selected',
                      })
                    : t('medications.weekdays.notSelected', {
