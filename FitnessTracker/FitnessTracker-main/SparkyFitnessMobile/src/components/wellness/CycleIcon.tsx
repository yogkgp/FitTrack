        ...
        return (
          <>
            <Circle
              ...
              cy="15"
              r="7.5"
              fill={tokens.phaseLuteal}
              opacity={0.5}
            />
            <Path
              d="M9 8 l1.6 2.6 M14 6.5 l0 3 M19 8 l-1.6 2.6"
              stroke={tokens.phaseLuteal}
              strokeWidth="1.8"
              strokeLinecap="round"
            />
          </>
