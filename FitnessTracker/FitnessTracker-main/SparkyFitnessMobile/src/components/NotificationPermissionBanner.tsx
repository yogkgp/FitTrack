...
const NotificationPermissionBanner =
  forwardRef<NotificationPermissionBannerHandle>((_, ref) => {
    const notificationsEnabled = useAppPreferencesStore(
      (s) => s.notificationsEnabled
    );

    const [osStatus, setOsStatus] = useState<AppNotificationPermission | null>(
      null
    );
    ...
    const visible =
      ...
      (osStatus === 'denied' || osStatus === 'undetermined');
